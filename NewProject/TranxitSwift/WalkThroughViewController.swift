...
class WalkThroughViewController: UIPageViewController {
    ...
    private let walkThroughData = [(Constants.string.walkthroughTitle1, Constants.string.walkthroughSubtitle1),(Constants.string.walkthroughTitle2, Constants.string.walkthroughSubtitle2),(Constants.string.walkthroughTitle3, Constants.string.walkthroughSubtitle3)]
...
extension WalkThroughViewController {
    ...
    private func initialLoads(){
        ...
        self.setViewControllers([walkThroughControllers[0]], direction: .reverse, animated: true, completion: nil)
